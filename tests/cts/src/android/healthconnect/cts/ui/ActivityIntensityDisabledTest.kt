...
@RequiresFlagsDisabled(FLAG_ACTIVITY_INTENSITY)
class ActivityIntensityDisabledTest : BaseDataTypeDisabledTest() {
    override val permissions = listOf(READ_ACTIVITY_INTENSITY, WRITE_ACTIVITY_INTENSITY)
    override val anotherPermission = HealthPermissions.READ_HEIGHT
    override val anotherPermissionString = "Height"
}
