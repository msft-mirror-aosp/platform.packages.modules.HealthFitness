...
public final class RecordProtoConverter {
    ...
    @NonNull
    public RecordInternal<?> toRecordInternal(@NonNull Record recordProto)
    ...
    private int getRecordId(@NonNull Record protoRecord) {
    ...
    @RecordTypeIdentifier.RecordType
    private int getIntervalRecordId(@NonNull IntervalRecord protoRecord) {
    ...
    @RecordTypeIdentifier.RecordType
    private int getInstantRecordId(@NonNull InstantRecord protoRecord) {
